...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(monokai hemisu-light)
  ...
  (add-hook 'tuareg-mode-hook
            '(lambda ()
               ...
               (setq ff-other-file-alist '(("\\.mli\\'" (".ml"))
                                           ...
                                           ("\\.eliomi\\'" (".eliom"))
                                           ("\\.eliom\\'" (".eliomi"))))
               ;; Use C-c C-a to switch between .eliom/.eliomi and vice versa.
